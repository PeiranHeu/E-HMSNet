...
if __name__ == '__main__':
    ...
    parser.add_argument("--logdir", default="/home/nie/code/zcz/LASnet1/model/", type=str,
                        help="run logdir")
    parser.add_argument("-s", type=bool, default="/home/nie/code/zcz/LASnet1/model",
